...
const PRIORITY_CONFIG = {
  high:   { labelRu: lang === 'en' ? 'High' : 'Высокий', labelEn: 'High',   color: '#FF4466', xp: 50 },
  medium: { labelRu: lang === 'en' ? 'Medium' : 'Средний', labelEn: 'Medium', color: '#F0A30A', xp: 25 },
  low:    { labelRu: lang === 'en' ? 'Low' : 'Низкий',  labelEn: 'Low',    color: '#5CB85C', xp: 10 },
}
